...
latex_documents = [
    (master_doc, 'synospec.tex', 'SynOSpec Documentation',
     'Kyle B. Westfall', 'manual'),
]
...
man_pages = [
    (master_doc, 'synospec', 'SynOSpec Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'SynOSpec', 'SynOSpec Documentation',
     author, 'synospec', 'One line description of project.',
     'Miscellaneous'),
]
